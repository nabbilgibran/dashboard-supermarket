...
# Header Dashboard
header <- dashboardHeader(title = 'Supermarket US Dashboard', titleWidth = 285)

# Sidebar Dashboard
sidebar <- dashboardSidebar(width = 285,
                            sidebarMenu(
                              menuItem(text = "Overview", tabName = "overview", icon = icon("home")),
                              menuItem(text = "Supermarket Segment Analysis", tabName = "analysis1", icon = icon("chart-line")),
                              menuItem(text = "Supermarket Product Analysis", tabName = "analysis2", icon = icon("list")),
  ...
  tabItems(
    ...
    tabItem(tabName = "data",
            fluidRow(
              box(background = "blue",
                  width = 12,
                  title = h3("Supemarket US Database", align = "center"),
    ...
    tabItem(
      tabName = "about",
      fluidPage(
        h1("Supermarket US Dashboard"),
        p("By ", a("Nabbil Gibran Winitaris Entyo")),
        h2("Dataset"),
        h3("Context"),
